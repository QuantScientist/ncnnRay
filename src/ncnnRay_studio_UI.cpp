...
//        }
        ...
        if (texture.id > 0) {
            ...
            DrawTextEx(GuiGetFont(), "ncnn MODEL STUDIO: DRAG & DROP AN IMAGE.",
        ...
        if (GuiButton(Rectangle{screenWidth - leftPadding, screenHeight - smallPadding - 2 * padding, buttonWidth,
                                buttonHeight}, "LffdF")) {
        ...
        if (GuiButton(Rectangle{screenWidth - leftPadding, screenHeight - smallPadding - 3 * padding, buttonWidth,
                                buttonHeight}, "Udiny")) {
        ...
        if (GuiButton(Rectangle{screenWidth - leftPadding, screenHeight - smallPadding - 4 * padding, buttonWidth,
                                buttonHeight}, "Mosaic")) {
        ...
        if (GuiButton(Rectangle{screenWidth - leftPadding, screenHeight - smallPadding - 5 * padding, buttonWidth,
                                buttonHeight}, "RetinaF")) {
...
//
        if (GuiButton(Rectangle{screenWidth - leftPadding, screenHeight - smallPadding - 6 * padding, buttonWidth,
                                buttonHeight}, "FV512")) {
...
//            ImageColorBrightness(&image, +40);
        ...
        randomSeed = GuiSlider(
                Rectangle{screenWidth - leftPadding, screenHeight - smallPadding - 7 * padding, buttonWidth / 2, 15},
...
//        GuiUnlock();
        if (GuiButton(Rectangle{screenWidth - leftPadding, screenHeight - smallPadding - 12 * padding, buttonWidth,
                                buttonHeight}, "SAVE")) {
